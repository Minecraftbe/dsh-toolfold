...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var DEFAULT_SETTINGS = { enabled: true, durMs: 240, keepThink: false, splitThink: true, stats: false };

    function loadSettings() {
      var base = { enabled: true, durMs: DEFAULT_SETTINGS.durMs, keepThink: DEFAULT_SETTINGS.keepThink, splitThink: DEFAULT_SETTINGS.splitThink, stats: false };
