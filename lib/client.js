 ...
 *     run follows upward continuously — no blank hole and no end snap. When
 *     the reader is pinned near the bottom, expanding keeps the bar's
 *     viewport position fixed (the product's sticky-bottom follow would
 *     otherwise shove the bar out of the top).
 *
